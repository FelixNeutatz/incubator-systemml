...
public class MatrixScalarRelationalFLInstruction extends RelationalBinaryFLInstruction  
{
	
	public MatrixScalarRelationalFLInstruction(Operator op, CPOperand in1, CPOperand in2, CPOperand out, String opcode, String istr)
	{
