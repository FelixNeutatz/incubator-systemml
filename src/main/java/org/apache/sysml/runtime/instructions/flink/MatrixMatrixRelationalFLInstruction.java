...
public class MatrixMatrixRelationalFLInstruction extends RelationalBinaryFLInstruction 
{
	
	public MatrixMatrixRelationalFLInstruction(Operator op, CPOperand in1, CPOperand in2, CPOperand out, String opcode, String istr) 
